...
require('./assets/Game/Scripts/i18n');
...
require('./assets/Game/Scripts/ui/GameOver');
...
require('./assets/Game/Scripts/ui/OpenGuide');
require('./assets/Game/Scripts/ui/OverDialog');
...
require('./assets/Game/Scripts/ui/WeChatDialog');
require('./assets/Game/Scripts/ui/WinDialog');
require('./assets/Game/Scripts/ui/popup_GameOver');
